...
namespace pu::ui::render {
    ...
    class Renderer {
        ...
        public:
            ...
            void RenderRoundedRectangleBorder(const Color clr, const s32 x, const s32 y, const s32 width, const s32 height, const s32 radius, const u32 thickness);
            ...
            /**
             * @brief Renders a background/dark shadow to the screen.
             * @param x The X position to render the shadow around.
             * @param y The Y position to render the shadow around.
             * @param width The width to render the shadow around.
             * @param height The width to render the shadow around.
             * @param radius The base radius for the shadow edges.
             * @param start_alpha The starting alpha value of the shadow.
             * @param intensity The intensity of the shadow (0 to 255, opposite to an alpha value).
             * @param length The length of the shadow (how many pixels it extends out of the base dimensions).
             */
            void RenderBackgroundShadow(const s32 x, const s32 y, const s32 width, const s32 height, const u32 radius, const u8 start_alpha, const u8 intensity, const u32 length);

            /**
             * @brief Pushes a render region to the stack, so that anything outside of it will not be rendered (essentially pushes a clipping region).
             * @param x The X position of the render region.
             * @param y The Y position of the render region.
             * @param width The width of the render region.
             * @param height The height of the render region.
             * @note This function should be called each render loop / OnRender call, along with a corresponding PopRenderRegion.
             */
            void PushRenderRegion(const s32 x, const s32 y, const s32 width, const s32 height);

            /**
             * @brief Pops a render region from the stack, so that anything outside of it will be rendered again.
             * @note This function should be called each render loop / OnRender call, after a corresponding PushRenderRegion.
             */
            void PopRenderRegion();
