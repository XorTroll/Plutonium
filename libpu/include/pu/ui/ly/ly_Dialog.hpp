...
namespace pu::ui::ly {
    ...
    /**
     * @brief Layer that represents a dialog, which is a simple way to show a message and various options to the user and get a response.
     */
    class Dialog final : public Layer {
        public:
